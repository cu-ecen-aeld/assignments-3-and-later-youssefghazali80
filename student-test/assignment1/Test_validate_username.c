...
void test_validate_my_username()
{
    ...
    char * conf_file_user_name = malloc_username_from_conf_file();
     
    TEST_ASSERT_EQUAL_STRING_MESSAGE(user_name, conf_file_user_name,"Usernames does not match");
    
    free (conf_file_user_name);
}
